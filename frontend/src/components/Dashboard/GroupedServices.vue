<template>
  <div class="row">
    <h5 v-if="group.name && group_services" class="h5 col-12 mb-3 mt-2 text-dim">
      ...
      <span class="badge badge-success text-lowercase float-right ml-2">{{services_online.length}} {{$t('online')}}</span>
      <span v-if="services_online.services_offline > 0" class="badge badge-danger text-lowercase float-right">
